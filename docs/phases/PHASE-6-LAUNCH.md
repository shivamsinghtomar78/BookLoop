...
3. ~~Host realtime externally~~ **Solved by D-060** — socket.io deploys with the app on Vercel (`api/socketio.ts`); nothing extra to host. Verify "⚡ live" appears in a prod chat after deploy.
